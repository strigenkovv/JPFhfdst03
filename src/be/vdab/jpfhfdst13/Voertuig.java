...
public abstract class Voertuig implements Privaat, Milieu {
    ...
    public void geefPrivateData() {
        IO.println("Polishouder: " + getPolishouder());
        IO.println("Nummerplaat: " + getNummerplaat());
    }

    @Override
    public void geefMilieuData() {
        IO.println("PK: " + getPk());
        IO.println("Kostprijs: " + getKostprijs());
        IO.println("Gemiddeld verbruik: " + getGemVerbruik());
    }
}
